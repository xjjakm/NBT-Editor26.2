...
---
 ...
 - **I only provide support for MC version 26.2; version 26.1.x is not supported.**
...
**log**
Upload your game log here(latest.log).In some cases it is inconsequential, but if you see a large number of error outputs in the log, please be sure to upload it.

**crash report**
If the game crashes, please upload the crash report here.
